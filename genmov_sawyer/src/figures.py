...
def figures(x_real,x_actual,x_error,x_deseado,y_real,y_actual,y_error,y_deseado,z_real,z_actual,z_error,z_deseado,q_plot):
        ...
        ax.plot(x_actual, y_actual, z_actual, label='Trayectoria robótica realizada')
        ax.plot(x_deseado,y_deseado, z_deseado, label='Trayectoria robótica deseada')
        ax.plot(x_real,y_real, z_real, label='Trayectoria real humana')
        ax.set_xlabel('X')
        ax.set_ylabel('Y')
        ax.set_zlabel('Z')
        ax.legend()
