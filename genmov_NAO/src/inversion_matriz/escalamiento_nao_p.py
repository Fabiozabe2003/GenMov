...
dir=sys.argv[1]
print(dir)
directory = '/home/andres/momask-codes/motions/nao/{}'.format(dir)
files = os.listdir(directory)
file=files[1] #En este caso files[1] es el que no es ik
...
filename = '/home/andres/proy_ws/src/GenMov/genmov_NAO/src/motions/{dir}.csv'.format(dir=dir)
