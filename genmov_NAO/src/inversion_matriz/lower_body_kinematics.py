...
def fkine_left_foot_constant(q,qf,t):
    T0=fkine_left_leg(q,qf,t)
    T1=Trasl(0.03,0.04519,0)
    return T0@T1

def fkine_right_foot_constant(q,qf,t):
    T0=fkine_right_leg(q,qf,t)
    T1=Trasl(0.03,0.04519,0)
    R=Trotx(-pi/2)
    return T0@R@T1
